...
import { dateCannotBeInFuture, firstLetterShouldBeUppercase } from '../../shared/functions/validations';
...
export class ActorsFormComponent implements OnInit{
  ...
  form= this.formBuilder.group({
    ...
    dateOfBirth: new FormControl<Date | null>(null, {validators: [Validators.required, dateCannotBeInFuture()]}),
  ...
  getErrorMessagesForDateOfBirth():string{
    ...
    if(field.hasError('dateCannotBeInFuture')){
      return field.getError('dateCannotBeInFuture').message;
    }
